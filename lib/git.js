...
(function() {
  var colors, exec, getBranch, getFailure, getPass, getRunner, getSuccess, getUser, git, gitContinue, readyCallback;
  ...
  getSuccess = function() {
    var _this = this;
    return exec('git config --get ' + git.config.success, function(error, stdout, stderr) {
      if (error != null) {
  ...
  getFailure = function() {
    var _this = this;
    return exec('git config --get ' + git.config.failure, function(error, stdout, stderr) {
      if (error != null) {
